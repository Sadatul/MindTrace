    ...
    Scaffold(
        ...
        topBar = {
            CenterAlignedTopAppBar(
                ...
                },                actions = {                    Box {                        IconButton(onClick = { showProfileMenu = true }) {
                            // Show user's Google profile picture if available, otherwise show account icon
                        ...
                        DropdownMenu(
                            ...
                            DropdownMenuItem(
                                text = {
                                    ...
                                    // Sign out the user and show close app dialog immediately
                            ...
                            DropdownMenuItem(
                                text = {
                                    ...
                                    showProfileMenu = false
                                    // Sign out current user and trigger account chooser for login
                                    coroutineScope.launch {
                                        try {
                                            RetrofitInstance.dementiaAPI.signOutUser()
                                            onLoginWithAnotherAccount()
                                        } catch (e: Exception) {
                                            Log.e(TAG, "Error signing out for account switch", e)
                                            onLoginWithAnotherAccount() // Still try to show login options
                                        }
                                    }
                                }
                            )
        ...
        Box(
            ...
            Column(
                ...
                Column(
                    ...
                    // Enhanced Help & Support Chat Button
                    Button(
                    ...
                    // Enhanced Get Code for New Patient Button
                    Button(
                        onClick = {
                        ...
                        Row(
                            ...
                            Spacer(modifier = Modifier.width(12.dp))
                            Text(
                                if (isLoading) "Generating Code..." else "Get Code for New Patient",
                                fontWeight = FontWeight.Bold,
                                style = MaterialTheme.typography.titleMedium
                            )
